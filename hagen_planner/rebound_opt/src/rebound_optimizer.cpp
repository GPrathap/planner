...
namespace ego_planner
{
  ...
  bool BsplineOptimizer::rebound_optimize()
  {
    ...
    cout << "=================2" << this->cps_.size << " " << end_id << endl;
    ...
    do
    {
      ...
      flag_occ = false;
      success = false;
      cout << "=================5" << cps_.points.size() << endl;
      cout << "=================5" <<  start_id << endl;
      cout << "=================5" <<  variable_num_ << endl;
      ...
      {
        // cout << "Solver error in planning!, return = %s", lbfgs::lbfgs_strerror(result))<< endl;
        flag_force_return = false;
