...
class Visualiser:
    ...
    def init_plot(self):
        ...
        self.ax1.vlines(x=[800, 6500], ymin=ymin, ymax=ymax, linewidth=6, color='g')
        ...
        self.ax2.vlines(x=[800, 6500], ymin=ymin, ymax=ymax, linewidth=6, color='g')
        ...
        self.ax3.vlines(x=[800, 6500], ymin=ymin, ymax=ymax, linewidth=6, color='g')
        ...
        self.ax4.vlines(x=[800, 6500], ymin=ymin, ymax=ymax, linewidth=6, color='g')
