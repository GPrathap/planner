...
struct GridNode
{
	...
	double gScore{std::numeric_limits<double>::infinity()}, fScore{std::numeric_limits<double>::infinity()};
...
public:
	...
	void initGridMap(hagen_planner::EDTEnvironment::Ptr occ_map, const Eigen::Vector3i pool_size);
